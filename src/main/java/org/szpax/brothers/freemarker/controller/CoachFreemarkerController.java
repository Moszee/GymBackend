...
public class CoachFreemarkerController {
    ...
    @Autowired
    public CoachFreemarkerController(CoachService coachService) {this.coachService =coachService;}

    @RequestMapping("/add")
    public String addCoach(Map<String, Object> model) {return "addCoach"; }

    @RequestMapping(value = "/save", method = POST)
    public String saveCoach(
            @RequestParam String firstName,
            @RequestParam String lastName,
            @RequestParam @DataTimeFormat(pattern = "yyyy-MM-dd") Date birthDate,
            @RequestParam @DataTimeFormat(pattern = "yyyy-MM-dd") Date employmentDate,
